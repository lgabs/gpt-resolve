import pytest
import base64
from src.resolve import encode_image, extract_question_description, resolve_question
...
def test_extract_question_description_success(mock_question_description_client):
    ...
    # Act
    description, tokens = extract_question_description(question_image, conventions_image)
